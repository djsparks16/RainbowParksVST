...
juce::AudioProcessorValueTreeState::ParameterLayout FiveParksVST3AudioProcessor::createParameters()
{
    ...
    p.push_back(pc("noise_type", "Noise Type", { "White", "Air", "Metal", "Crunch", "Vowel" }, 0));
    ...
    p.push_back(pc("bass_mode", "Bass Mode", { "Init", "Reese", "Womp", "Screech", "Warhorn", "Whoop", "Donk", "Tearout" }, 0));
...
void FiveParksVST3AudioProcessor::handleSustainPedal(bool down)
{
    ...
    for (int midiNote : sustainedNotes)
        noteOff(midiNote);
