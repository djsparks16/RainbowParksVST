...
private:
    ...
    juce::Component oscABox, oscBBox, subBox, noiseBox, filterBox, bassBox, envBox, lfoBox, matrixBox, fxBox, perfBox, displayBox;
    ...
    SerumKnob reeseAmt, warhornAmt, wompAmt, subharmAmt, comboAmt, stereoWidth, fmAmt, airAmt, bodyAmt, growlAmt, toneAmt, motionAmt;
    SerumKnob screechAmt, whoopAmt, vowelAmt, smearAmt;
    ...
    juce::ComboBox subWave, noiseType, filterMode, bassMode, playMode, polyphony;
